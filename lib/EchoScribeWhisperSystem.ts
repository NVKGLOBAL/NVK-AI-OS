import type { AgentPersona, WhisperTrigger as CoreWhisperTrigger } from './whisper/WhisperRegistry'; // Corrected import path
...
import { whisperRegistry } from './whisper/WhisperRegistry';
