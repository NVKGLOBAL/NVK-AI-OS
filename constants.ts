...
export const PANEL_DEFINITIONS: PanelDefinition[] = [
  { id: 'SystemMonitorPanel', name: 'NVK System Monitor', icon: 'ri-cpu-line', description: 'Monitor OS resources, ML context, and Task Engine.', category: 'Core Systems' },
  ...
  { id: 'DocumentWorkspace', name: 'Document & Pitch Deck', icon: 'ri-presentation-line', description: 'Living presentation decks, briefs, and markdown artifacts generated by NVK.', category: 'Core Systems' },
  { id: 'WorkflowWorkspace', name: 'Workflow & Task Radar', icon: 'ri-git-merge-line', description: 'Persistent autonomous workflows, research pipelines, and siting radars.', category: 'Core Systems' },
  { id: 'SubAgentConstellation', name: 'Sub-Agent Fleet', icon: 'ri-group-line', description: 'Real-time telemetry and task delegation across specialized sub-agent nodes.', category: 'Core Systems' },
